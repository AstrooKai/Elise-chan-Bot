...
$interactionReply[;{newEmbed:{title:UNBANNED!}{description:*Yosano has decided to keep you alive. Consider yourself (un)lucky,* ***$userTag[$findMember[$slashOption[user]]***.}{image:http\://co.daki.cc\:4188/media/unban.gif}{color:#bd7a21}};;;all;no]
