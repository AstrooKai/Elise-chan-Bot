...
$interactionReply[;{newEmbed:{title:RELEASED!}{description:***$userTag[$findMember[$message[1];no]]*** *has been granted mercy by the Port Mafia.*}{color:#bd7a21}};;;all;no]

$takeRole[$guildID;$findMember[$slashOption[user];no];933655133332602880]
