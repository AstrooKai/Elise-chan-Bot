module.exports = {
  ...
  code: `$channelSendMessage[$getVar[logChannel];{newEmbed:{title:Kick Log}{field:Staff:<@$authorID> ($authorID)}{field:User Kicked:<@$$findMember[$message[1];no]> ($findMember[$message[1];no])}{field:Reason:$if[$checkContains[$splitText[2];!r]==true;$splitText[2];No Reason Specified]}{field:Time & Date:<t:$truncate[$divide[$dateStamp;1000]]:F>}{field:Place of Occurrence:<#$channelID> ($channelID)}{color:$getVar[default]}{timestamp}}]
$title[1;KICKED!]
