...
$image[1;http#COLON#//82.223.64.239#COLON#27621/media/unban.gif]
...
$onlyIf[$userExists[$findMember[$message[1];false];$guildID]!=;{newEmbed:{author:ERR-00 User Invalid:http#COLON#//82.223.64.239#COLON#27621/media/err.png}{description:$getVar[err00]}{color:Red}]
$argsCheck[>0;{newEmbed:{author:ERR-02 Bad Request:http#COLON#//82.223.64.239#COLON#27621/media/err.png}{description:$getVar[err02]}{field:Usage:$jsonRequest[http#COLON#//82.223.64.239#COLON#27621/commands/unban;Usage]:yes}{color:Red}}]
