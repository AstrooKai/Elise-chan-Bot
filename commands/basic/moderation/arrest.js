module.exports = {
  name: "arrest",
  aliases: ["rashomon"],
  code: `$channelSendMessage[$getVar[logChannel];{newEmbed:{title:Arrest Log}{field:Staff:<@$authorID> ($authorID)}{field:User Arrested:<@$findMember[$message[1];no]> ($findMember[$message[1];no])}{field:Time & Date:<t:$truncate[$divide[$dateStamp;1000]]:F>}{field:Place of Occurrence:<#$channelID> ($channelID)}{color:$getVar[default]}{timestamp}}]
$title[1;ARRESTED!]
$description[1;***$userTag[$findMember[$message[1];no]]*** *broke a leg. Oops.*]
$image[1;http://co.daki.cc:4188/media/arrest.gif]
...
$argsCheck[>0;{newEmbed:{author:ERR-02 Bad Request:http://co.daki.cc:4188/media/err.png}{description:$getVar[err02]}{field:Usage:$jsonRequest[http://co.daki.cc:4188/commands/arrest;Usage]:yes}{color:$getVar[red]}}]
