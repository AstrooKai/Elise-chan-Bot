module.exports = [{
  ...
  name: "captcha",
  type: "join",
  code: `$channelSendMessage[933384124289417236;<@$authorID>{newEmbed:{author:Verification:http://co.daki.cc:4188/media/verify-shield.png}{description:Welcome to **Bar Lupin**! Please solve the captcha below to verify that you are not a bot, this is to prevent unwanted accounts that may cause issues in the community.\n\nTo verify, simply find the six character code in the image below and use the \`>verify\` command. You can refer to the usage and example below for guidance. You only have 10 minutes to complete this. Failing to complete results to auto-kick.\n\n**Usage**\n\`\`\`\n>verify <code>\n\`\`\`\n**Example**\n\`\`\`\n>verify ABCDEF\n\`\`\`}{image:$getobjectProperty[image]}{color:$getVar[default]}{timestamp}};false]
...
$cooldown[3s;{newEmbed:{author:ERR-06 Cooldown:http://co.daki.cc:4188/media/err.png}{description:$getVar[err06] %time%!}{color:$getVar[red]}}]
