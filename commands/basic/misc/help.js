module.exports = {
  name: "help",
  code: `$author[1;Help | $getObjectProperty[CommandName];http#COLON#//82.223.64.239#COLON#27621/media/info.png]
...
$color[#1e90ff]
$createObject[$jsonRequest[http#COLON#//82.223.64.239#COLON#27621/commands/$message[1]]]
$onlyIf[$checkContains[$message[1];arrest;ban;kick;release;unban;addgif;addmeme;bungogif;bungomeme;eval;help;reboot;status;system;update]==true;{newEmbed:{author:Help | List:http#COLON#//82.223.64.239#COLON#27621/media/info.png}{field:Moderation:arrest, ban, kick, release, unban:no}{field:Fun:addgif, addmeme, bungogif, bungomeme:no}{field:Misc:eval, help, reboot, status, system, update:no}{color:#1e90ff}}]`
}