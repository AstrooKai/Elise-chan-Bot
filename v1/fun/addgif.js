...
axios.post('https://eca.kyle9.repl.co/bungogifs', {link:"$splitText[1]", name:"$splitText[2]"})
.then((res) => {
...
$onlyIf[$stringEndsWith[$message[1];.gif]==true;{title:HTTP 400}{description:Request declined. URL must end with \`.gif\`!}{color:$getVar[red]}]
