...
axios.post('https://eca.astrookai.repl.co/bungogifs', {link:"$splitText[1]", name:"$splitText[2]"})
.then((res) => {
...
$onlyIf[$stringEndsWith[$message[1];.gif]==true;{newEmbed:{author:ERR-07.400 API Error:https://eca.astrookai.repl.co/media/err.png}{description:The request has been declined, the image URL must end with \`.gif\`!}{color:$getVar[red]}}]
